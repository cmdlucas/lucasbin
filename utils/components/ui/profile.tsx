    ...
    <Division type="bottom">
        <FlexRowNoWrap>
            ...
            <BottomOnBorderContent>
                <Link href="/projects">
                    <a><PrimaryButton style={{ position: "absolute", top: "10px", right: "16px" }}> PROJECTS </PrimaryButton></a>
                </Link>
            </BottomOnBorderContent>
        </FlexRowNoWrap>
    </Division>
